	...
	<view class="vipCenterPage">
		...
		<view class="list">
			<uni-list>
				...
				<uni-list-item  :title="pageList[2].title"  @click="handleClick(2)"  :thumb="pageList[2].thumbUrl" :show-badge="true" :badge-text="'需实名认证'"></uni-list-item>
			</uni-list>
		</view>
	</view>
</template>
...
.vipCenterPage {
	...
	.list{
		...
		.uni-list-item{
			.uni-list-item__container .uni-list-item__extra{
				width: 50%;
				.uni-badge-success{
					color: #fd9c67;
