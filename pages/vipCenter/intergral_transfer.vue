			...
			<view class="input-group">
				<form @submit="formSubmit">
					...
					<view class="uni-form-item uni-row uni-flex" :class="isNumInvaild?'error':''">
						...
						<input class="uni-input uni-flex-item" type="number" v-model="num" name="num" placeholder="请输入转让数量" />
					...
					<view class="uni-form-item uni-row uni-flex">
						...
						<input class="uni-input uni-flex-item" v-model="id" name="id" placeholder="请输入转入的会员ID" />
					</view>
